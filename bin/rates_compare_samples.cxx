...
void rates(bool newConditions, const std::string& inputFileDirectory){
  ...
  TH1F* hcalTP_Barrel_HT120_emu = new TH1F("hcalTP_Barrel_HT120_emu", ";TP E_{T}; # Entries", nTpBins, tpLo, tpHi);
  TH1F* hcalTP_Endcap_HT120_emu = new TH1F("hcalTP_Endcap_HT120_emu", ";TP E_{T}; # Entries", nTpBins, tpLo, tpHi);
  TH1F* hcalTP_Barrel_HT360_emu = new TH1F("hcalTP_Barrel_HT360_emu", ";TP E_{T}; # Entries", nTpBins, tpLo, tpHi);
  TH1F* hcalTP_Endcap_HT360_emu = new TH1F("hcalTP_Endcap_HT360_emu", ";TP E_{T}; # Entries", nTpBins, tpLo, tpHi);

  TH1F* hHTSum_emu = new TH1F("hHTSum_emu", ";H_{T}; # Entries", nHtSumBins, htSumLo, htSumHi);
  TH1F* hETSum_emu = new TH1F("hETSum_emu", ";E_{T}; # Entries", nEtSumBins, etSumLo, etSumHi);
  TH1F* hMETSum_emu = new TH1F("hMETSum_emu", ";MET; # Entries", nMetSumBins, metSumLo, metSumHi);
  TH1F* hMETHFSum_emu = new TH1F("hMETHFSum_emu", ";MET HF; # Entries", nMetHFSumBins, metHFSumLo, metHFSumHi);
  TH1F* hMHTSum_emu = new TH1F("hMHTSum_emu", ";MHT; # Entries", nMhtSumBins, mhtSumLo, mhtSumHi);

  TH1F* hJetET_emu = new TH1F("hJetET_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_Leading1_emu = new TH1F("hJetET_Leading1_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_Leading2_emu = new TH1F("hJetET_Leading2_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_Leading3_emu = new TH1F("hJetET_Leading3_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_Leading4_emu = new TH1F("hJetET_Leading4_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);

  TH1F* hJetET_HT120_emu = new TH1F("hJetET_HT120_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_HT120_Leading1_emu = new TH1F("hJetET_HT120_Leading1_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_HT120_Leading2_emu = new TH1F("hJetET_HT120_Leading2_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_HT120_Leading3_emu = new TH1F("hJetET_HT120_Leading3_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_HT120_Leading4_emu = new TH1F("hJetET_HT120_Leading4_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);

  TH1F* hJetET_HT360_emu = new TH1F("hJetET_HT360_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_HT360_Leading1_emu = new TH1F("hJetET_HT360_Leading1_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_HT360_Leading2_emu = new TH1F("hJetET_HT360_Leading2_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_HT360_Leading3_emu = new TH1F("hJetET_HT360_Leading3_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);
  TH1F* hJetET_HT360_Leading4_emu = new TH1F("hJetET_HT360_Leading4_emu", ";E_{T}; # Entries", nJetBins, jetLo, jetHi);


  TH1F* hJetEta_emu = new TH1F("hJetEta_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_Leading1_emu = new TH1F("hJetEta_Leading1_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_Leading2_emu = new TH1F("hJetEta_Leading2_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_Leading3_emu = new TH1F("hJetEta_Leading3_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_Leading4_emu = new TH1F("hJetEta_Leading4_emu", ";#eta; # Entries", 50, -5, 5);

  TH1F* hJetEta_HT120_emu = new TH1F("hJetEta_HT120_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_HT120_Leading1_emu = new TH1F("hJetEta_HT120_Leading1_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_HT120_Leading2_emu = new TH1F("hJetEta_HT120_Leading2_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_HT120_Leading3_emu = new TH1F("hJetEta_HT120_Leading3_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_HT120_Leading4_emu = new TH1F("hJetEta_HT120_Leading4_emu", ";#eta; # Entries", 50, -5, 5);

  TH1F* hJetEta_HT360_emu = new TH1F("hJetEta_HT360_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_HT360_Leading1_emu = new TH1F("hJetEta_HT360_Leading1_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_HT360_Leading2_emu = new TH1F("hJetEta_HT360_Leading2_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_HT360_Leading3_emu = new TH1F("hJetEta_HT360_Leading3_emu", ";#eta; # Entries", 50, -5, 5);
  TH1F* hJetEta_HT360_Leading4_emu = new TH1F("hJetEta_HT360_Leading4_emu", ";#eta; # Entries", 50, -5, 5);

  TH1F* hNJets_emu = new TH1F("hNJets_emu", ";N_{j}; # Entries", 20, -0.5, 19.5);
  TH1F* hNJets_HT120_emu = new TH1F("hNJets_HT120_emu", ";N_{j}; # Entries", 20, -0.5, 19.5);
  TH1F* hNJets_HT360_emu = new TH1F("hNJets_HT360_emu", ";N_{j}; # Entries", 20, -0.5, 19.5);

  TH1F* hNJets_Good_emu = new TH1F("hNJets_Good_emu", ";N_{j}; # Entries", 20, -0.5, 19.5);
  TH1F* hNJets_Good_HT120_emu = new TH1F("hNJets_Good_HT120_emu", ";N_{j}; # Entries", 20, -0.5, 19.5);
  TH1F* hNJets_Good_HT360_emu = new TH1F("hNJets_Good_HT360_emu", ";N_{j}; # Entries", 20, -0.5, 19.5);
...
//Fill histograms for comparing samples 
      hHTSum_emu->Fill(htSum);
      hETSum_emu->Fill(etSum);
      hMETSum_emu->Fill(metSum);
      hMETHFSum_emu->Fill(metHFSum);
      hMHTSum_emu->Fill(mhtSum);

      int nJetemu = l1emu_->nJets;
      hNJets_emu->Fill(nJetemu);
      hNJets_HT120_emu->Fill(nJetemu);
      hNJets_HT360_emu->Fill(nJetemu);
      int nGoodJets_pt20 = 0;
      for (int jetIt = 0; jetIt < nJetemu; jetIt++)
      {
          if (abs(l1emu_->jetEta[jetIt]) < 3 && l1emu_->jetEt[jetIt] > 20) nGoodJets_pt20 ++;
          if (abs(l1emu_->jetEta[jetIt]) < 3) 
          {
              hJetET_emu->Fill(l1emu_->jetEt[jetIt]);
              if (jetIt == 0) hJetET_Leading1_emu->Fill(l1emu_->jetEt[jetIt]);
              if (jetIt == 1) hJetET_Leading2_emu->Fill(l1emu_->jetEt[jetIt]);
              if (jetIt == 2) hJetET_Leading3_emu->Fill(l1emu_->jetEt[jetIt]);
              if (jetIt == 3) hJetET_Leading4_emu->Fill(l1emu_->jetEt[jetIt]); 
          }
          if (l1emu_->jetEt[jetIt] > 20)
          {
              hJetEta_emu->Fill(l1emu_->jetEta[jetIt]);
              if (jetIt == 0) hJetEta_Leading1_emu->Fill(l1emu_->jetEta[jetIt]);
              if (jetIt == 1) hJetEta_Leading2_emu->Fill(l1emu_->jetEta[jetIt]);
              if (jetIt == 2) hJetEta_Leading3_emu->Fill(l1emu_->jetEta[jetIt]);
              if (jetIt == 3) hJetEta_Leading4_emu->Fill(l1emu_->jetEta[jetIt]); 
          }
          if (htSum > 120)
          {
              if (abs(l1emu_->jetEta[jetIt]) < 3)
              {
                  hJetET_HT120_emu->Fill(l1emu_->jetEt[jetIt]);
                  if (jetIt == 0) hJetET_HT120_Leading1_emu->Fill(l1emu_->jetEt[jetIt]);
                  if (jetIt == 1) hJetET_HT120_Leading2_emu->Fill(l1emu_->jetEt[jetIt]);
                  if (jetIt == 2) hJetET_HT120_Leading3_emu->Fill(l1emu_->jetEt[jetIt]);
                  if (jetIt == 3) hJetET_HT120_Leading4_emu->Fill(l1emu_->jetEt[jetIt]); 
              }
              if (l1emu_->jetEt[jetIt] > 20)
              {
                  hJetEta_HT120_emu->Fill(l1emu_->jetEta[jetIt]);
                  if (jetIt == 0) hJetEta_HT120_Leading1_emu->Fill(l1emu_->jetEta[jetIt]);
                  if (jetIt == 1) hJetEta_HT120_Leading2_emu->Fill(l1emu_->jetEta[jetIt]);
                  if (jetIt == 2) hJetEta_HT120_Leading3_emu->Fill(l1emu_->jetEta[jetIt]);
                  if (jetIt == 3) hJetEta_HT120_Leading4_emu->Fill(l1emu_->jetEta[jetIt]); 
              }
          }
          if (htSum > 360)
          {
              if (abs(l1emu_->jetEta[jetIt]) < 3)
              {
                  hJetET_HT360_emu->Fill(l1emu_->jetEt[jetIt]);
                  if (jetIt == 0) hJetET_HT360_Leading1_emu->Fill(l1emu_->jetEt[jetIt]);
                  if (jetIt == 1) hJetET_HT360_Leading2_emu->Fill(l1emu_->jetEt[jetIt]);
                  if (jetIt == 2) hJetET_HT360_Leading3_emu->Fill(l1emu_->jetEt[jetIt]);
                  if (jetIt == 3) hJetET_HT360_Leading4_emu->Fill(l1emu_->jetEt[jetIt]); 
              }
              if (l1emu_->jetEt[jetIt] > 20)
              {
                  hJetEta_HT360_emu->Fill(l1emu_->jetEta[jetIt]);
                  if (jetIt == 0) hJetEta_HT360_Leading1_emu->Fill(l1emu_->jetEta[jetIt]);
                  if (jetIt == 1) hJetEta_HT360_Leading2_emu->Fill(l1emu_->jetEta[jetIt]);
                  if (jetIt == 2) hJetEta_HT360_Leading3_emu->Fill(l1emu_->jetEta[jetIt]);
                  if (jetIt == 3) hJetEta_HT360_Leading4_emu->Fill(l1emu_->jetEta[jetIt]); 
              }
          }

      }
      hNJets_Good_emu->Fill(nGoodJets_pt20);
      if (htSum > 120) hNJets_Good_HT120_emu->Fill(nGoodJets_pt20);
      if (htSum > 360) hNJets_Good_HT360_emu->Fill(nGoodJets_pt20);

      for(int i=0; i < l1TPemu_->nHCALTP; i++){
          double tpEt = l1TPemu_->hcalTPet[i];
          double tpIEta = l1TPemu_->hcalTPieta[i]; 
          hcalTP_emu->Fill(tpEt);

          if (abs(tpIEta) < 16)
          {
              hcalTP_Barrel_emu->Fill(tpEt);
              if (htSum > 120) hcalTP_Barrel_HT120_emu->Fill(tpEt);
              if (htSum > 360) hcalTP_Barrel_HT360_emu->Fill(tpEt);
          }
          if (abs(tpIEta) >= 16 && abs(tpIEta) < 29)
          {
              hcalTP_Endcap_emu->Fill(tpEt);
              if (htSum > 120) hcalTP_Endcap_HT120_emu->Fill(tpEt);
              if (htSum > 360) hcalTP_Endcap_HT360_emu->Fill(tpEt);
          }
      }
  ...
  if (emuOn){
    ...
    hcalTP_Barrel_HT120_emu->Write(); 
    hcalTP_Endcap_HT120_emu->Write();      
    hcalTP_Barrel_HT360_emu->Write();
    hcalTP_Endcap_HT360_emu->Write();

    hJetET_emu->Write();
    hJetET_Leading1_emu->Write();
    hJetET_Leading2_emu->Write();
    hJetET_Leading3_emu->Write();
    hJetET_Leading4_emu->Write();
    
    hJetET_HT120_emu->Write();
    hJetET_HT120_Leading1_emu->Write();
    hJetET_HT120_Leading2_emu->Write();
    hJetET_HT120_Leading3_emu->Write();
    hJetET_HT120_Leading4_emu->Write();

    hJetET_HT360_emu->Write(); 
    hJetET_HT360_Leading1_emu->Write(); 
    hJetET_HT360_Leading2_emu->Write(); 
    hJetET_HT360_Leading3_emu->Write(); 
    hJetET_HT360_Leading4_emu->Write(); 

    hJetEta_emu->Write(); 
    hJetEta_Leading1_emu->Write();
    hJetEta_Leading2_emu->Write();
    hJetEta_Leading3_emu->Write();
    hJetEta_Leading4_emu->Write();

    hJetEta_HT120_emu->Write(); 
    hJetEta_HT120_Leading1_emu->Write(); 
    hJetEta_HT120_Leading2_emu->Write(); 
    hJetEta_HT120_Leading3_emu->Write(); 
    hJetEta_HT120_Leading4_emu->Write(); 

    hJetEta_HT360_emu->Write();
    hJetEta_HT360_Leading1_emu->Write();
    hJetEta_HT360_Leading2_emu->Write();
    hJetEta_HT360_Leading3_emu->Write();
    hJetEta_HT360_Leading4_emu->Write();

    hNJets_emu->Write(); 
    hNJets_HT120_emu->Write(); 
    hNJets_HT360_emu->Write(); 
    hNJets_Good_emu->Write(); 
    hNJets_Good_HT120_emu->Write(); 
    hNJets_Good_HT360_emu->Write(); 
